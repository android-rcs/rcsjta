	...
	public ChatMessageDAO(final Context context, final String messageId) throws Exception {
		...
		try {
			...
			if (cursor.moveToFirst()) {
				...
				String _contact = cursor.getString(cursor.getColumnIndexOrThrow(ChatLog.Message.CONTACT_NUMBER));
				if (_contact != null) {
				...
				body = cursor.getString(cursor.getColumnIndexOrThrow(ChatLog.Message.BODY));
