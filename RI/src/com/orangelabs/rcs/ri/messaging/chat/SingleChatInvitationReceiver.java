...
public class SingleChatInvitationReceiver extends BroadcastReceiver {
    ...
    public static void addSingleChatInvitationNotification(Context context, Intent invitation) {
		...
		// Get chat ID
		String chatId = invitation.getStringExtra(ChatIntent.EXTRA_CHAT_ID);
        ...
        String msg = context.getString(R.string.label_from) + " " + contact;
        ...
        notificationManager.notify(chatId, Utils.NOTIF_ID_SINGLE_CHAT, notif);
    }
     ...
     */
    public static void removeSingleChatNotification(Context context, String sessionId) {
		NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);
		notificationManager.cancel(sessionId, Utils.NOTIF_ID_SINGLE_CHAT);
    }
}
