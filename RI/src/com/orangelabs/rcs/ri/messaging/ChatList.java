...
public class ChatList extends Activity implements JoynServiceListener {
    ...
    private class ChatListAdapter extends CursorAdapter {
    	...
    	public void bindView(View view, Context context, Cursor cursor) {
    		...
    		// Set icon
    		ImageView iconView = (ImageView)view.findViewById(R.id.call_icon);            
    		iconView.setImageDrawable(mDrawableChat);
		...
		public void onClick(View v) {
			...
			if (cache.isGroup) {
				...
				if (groupChat != null) {
					...
					if (state == ChatLog.Chat.State.TERMINATED_BY_USER) {
					...
					if (state == ChatLog.Chat.State.TERMINATED) {
