...
public class StreamingSessionView extends Activity {
    ...
    private MultimediaStreamingSessionListener serviceListener = new MultimediaStreamingSessionListener() {
        ...
        public void onStateChanged(ContactId contact, String sessionId,
            ...
            final String _reasonCode = RiApplication.sMessageReasonCodes[reasonCode.toInt()];
                ...
                public void run() {
                    ...
                    switch (state) {
                        ...
                        case FAILED:
                            ...
                            hideProgressDialog();
                            Utils.showMessageAndExit(StreamingSessionView.this,
                                    getString(R.string.label_session_failed, _reasonCode), exitOnce);
                            break;
                ...
                if (mode == StreamingSessionView.MODE_OPEN) {
                    ...
                    if (session == null) {
                        ...
                        Utils.showMessageAndExit(this,
                                getString(R.string.label_session_has_expired), exitOnce);
                        return;
                    }
    ...
    private void startSession() {
        ...
        try {
            // Initiate session
            session = connectionManager.getMultimediaSessionApi().initiateStreamingSession(
                    serviceId, contact);
