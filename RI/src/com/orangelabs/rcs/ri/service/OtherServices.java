...
public class OtherServices extends ListActivity {
    ...
    private BroadcastReceiver receiverResult = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String client = bundle
                    .getString(com.gsma.services.rcs.Intents.Service.EXTRA_PACKAGENAME);
            boolean status = bundle.getBoolean(com.gsma.services.rcs.Intents.Service.EXTRA_STATUS,
                    false);
