...
public class IPCallDAO implements Parcelable {
    ...
    private static final String WHERE_CLAUSE = new StringBuilder(IPCallLog.CALL_ID).append("=?")
            .toString();
     ...
     * 
     * @param context
     * @param callId the unique key field
     * @throws Exception
     */
    public IPCallDAO(final Context context, final String callId) throws Exception {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                videoEncoding = cursor.getString(cursor
                        .getColumnIndexOrThrow(IPCallLog.VIDEO_ENCODING));
                audioEncoding = cursor.getString(cursor
                        .getColumnIndexOrThrow(IPCallLog.AUDIO_ENCODING));
            } else {
    ...
    public String toString() {
        return "IPCallDAO [callId=" + callId + ", contact=" + contact + ", state=" + state
                + ", direction=" + direction + "]";
    }
