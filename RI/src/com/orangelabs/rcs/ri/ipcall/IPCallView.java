...
public class IPCallView extends Activity {
                    ...
                    switch (state) {
                        ...
                        case ABORTED:
                            ...
                            Utils.showMessageAndExit(IPCallView.this,
                                    getString(R.string.label_ipcall_aborted, _reasonCode),
                                    mExitOnce);
                            break;
                        ...
                        case REJECTED:
                            ...
                            hideProgressDialog();
                            Utils.showMessageAndExit(IPCallView.this,
                                    getString(R.string.label_ipcall_rejected, _reasonCode),
                                    mExitOnce);
                            break;
                        ...
                        case FAILED:
                            ...
                            hideProgressDialog();
                            Utils.showMessageAndExit(IPCallView.this,
                                    getString(R.string.label_ipcall_failed, _reasonCode), mExitOnce);
                            break;
                ...
                if (mode == IPCallView.MODE_OPEN) {
                    ...
                    if (call == null) {
                        ...
                        Utils.showMessageAndExit(this,
                                getString(R.string.label_ipcall_has_expired), mExitOnce);
                        return;
                    }
    ...
    private void startCall() {
        ...
        progressDialog.setOnCancelListener(new OnCancelListener() {
            public void onCancel(DialogInterface dialog) {
                Toast.makeText(IPCallView.this, getString(R.string.label_ipcall_canceled),
    ...
    private void addVideo() {
        ...
        // Display a progress dialog
        progressDialog = Utils.showProgressDialog(IPCallView.this,
                getString(R.string.label_command_in_progress));
        progressDialog.setOnCancelListener(new OnCancelListener() {
            public void onCancel(DialogInterface dialog) {
                // TODO
