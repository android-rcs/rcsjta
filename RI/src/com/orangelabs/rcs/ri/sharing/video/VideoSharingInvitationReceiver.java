...
public class VideoSharingInvitationReceiver extends BroadcastReceiver {
	 ...
	 */
	private static final String LOGTAG = LogUtils.getTag(VideoSharingInvitationReceiver.class.getSimpleName());
    ...
    */
	public static void addVideoSharingInvitationNotification(Context context, Intent invitation) {
		ContactId contact = invitation.getParcelableExtra(VideoSharingIntent.EXTRA_CONTACT);
		if (contact == null) {
        ...
        String notifTitle = context.getString(R.string.title_recv_video_sharing, contact.toString());
        Notification notif = new Notification(R.drawable.ri_notif_csh_icon, notifTitle, System.currentTimeMillis());
        notif.flags = Notification.FLAG_AUTO_CANCEL;
        notif.setLatestEventInfo(context, notifTitle, contact.toString(), contentIntent);
