...
import com.orangelabs.rcs.ri.sharing.video.player.DatagramConnection;
import com.orangelabs.rcs.ri.sharing.video.player.FifoBuffer;
import com.orangelabs.rcs.ri.sharing.video.player.NetworkRessourceManager;
...
public class RtpPacketReceiver extends Thread {
    ...
    public RtpPacketReceiver(int port, RtcpSession rtcpSession, int socketTimeout) throws IOException {
        ...
        datagramConnection = NetworkRessourceManager.createDatagramConnection(socketTimeout);
