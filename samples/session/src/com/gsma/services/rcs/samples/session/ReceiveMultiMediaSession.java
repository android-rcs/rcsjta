...
public class ReceiveMultiMediaSession extends Activity implements JoynServiceListener {
     ...
     */
    private static final String LOGTAG = LogUtils.getTag(ReceiveMultiMediaSession.class
            .getSimpleName());
     ...
     */
    private void addSessionInvitationNotification(Context context, String sessionId,
            ContactId contact) {
        ...
        Notification notif = new Notification(R.drawable.notif_invitation_icon, notifTitle,
                System.currentTimeMillis());
        notif.flags = Notification.FLAG_AUTO_CANCEL;
        notif.setLatestEventInfo(context, notifTitle,
                context.getString(R.string.label_recv_invitation, contact.toString()),
                contentIntent);
