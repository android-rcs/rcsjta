...
/**
 * Class CapabilityApiIntents.
 */
public interface CapabilityApiIntents {
    /**
     * Constant CONTACT_CAPABILITIES.
     */
    public static final String CONTACT_CAPABILITIES = "org.gsma.rcs.capability.CONTACT_CAPABILITIES";

    /**
     * Constant RCS_EXTENSIONS.
     */
    public static final String RCS_EXTENSIONS = "org.gsma.rcs.capability.EXTENSION";
