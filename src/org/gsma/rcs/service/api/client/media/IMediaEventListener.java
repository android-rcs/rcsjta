...
package org.gsma.rcs.service.api.client.media;
...
public interface IMediaEventListener extends android.os.IInterface {
     ...
     * Class Stub.
     */
    public abstract static class Stub extends android.os.Binder implements IMediaEventListener {
        /**
         ...
         */
        public static IMediaEventListener asInterface(android.os.IBinder arg1) {
            return (IMediaEventListener) null;
        }

    } // end Stub

} // end IMediaEventListener
