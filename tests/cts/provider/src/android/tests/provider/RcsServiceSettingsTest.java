...
public class RcsServiceSettingsTest extends InstrumentationTestCase {
    final String[] SETTINGS_PROJECTION = {
            RcsServiceConfiguration.Settings.KEY, RcsServiceConfiguration.Settings.VALUE
    };
    ...
    public void testRcsSettingsQueryProjection() {
        ...
        try {
            ...
            cursor = mProvider.query(RcsServiceConfiguration.Settings.CONTENT_URI, null, where,
                    whereArgs, null);
    ...
    public void testRcsSettingsQueryByKey() {
        ...
        try {
            ...
            String key = cursor.getString(cursor
                    .getColumnIndexOrThrow(RcsServiceConfiguration.Settings.KEY));
