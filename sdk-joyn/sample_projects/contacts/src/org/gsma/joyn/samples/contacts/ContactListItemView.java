...
public class ContactListItemView extends ViewGroup {
    ...
    private static final int QUICK_CONTACT_BADGE_STYLE = 16843442;
    ...
    public QuickContactBadge getQuickContact() {
        if (mQuickContact == null) {
            ...
            mQuickContact.setMode(ContactsContract.QuickContact.MODE_LARGE);
    ...
    public void setPresence(Drawable icon) {
        if (icon != null) {
            ...
            mPresenceIcon.setScaleType(ScaleType.FIT_XY);
