...
public class DialtactsActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    private void setupCallLogTab() {
        ...
        Intent intent = new Intent("com.orangelabs.rcs.phone.action.RECENT_CALLS");
        intent.setAction("com.orangelabs.rcs.phone.action.RECENT_CALLS");
    ...
    private void setupDialerTab() {
    	//TODO
        Intent intent = new Intent("com.orangelabs.rcs.phone.action.TOUCH_DIALER");
        intent.setAction("com.orangelabs.rcs.phone.action.TOUCH_DIALER");
    ...
    private boolean isSendKeyWhileInCall(final Intent intent, final boolean recentCallsRequest) {
        ...
        if (recentCallsRequest) {
          ...
          //TODO Check telephone status
            TelephonyManager telephonyManager = (TelephonyManager)this.getSystemService(Context.TELEPHONY_SERVICE);
            if (callKey && (telephonyManager.getCallState()!=TelephonyManager.CALL_STATE_IDLE)){
            	return true;
            }
          /*  
            try {
