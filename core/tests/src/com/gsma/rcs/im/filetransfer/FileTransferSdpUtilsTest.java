...
public class FileTransferSdpUtilsTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        sdp = "v=0" + SipUtils.CRLF + "o=- " + ntpTime + " " + ntpTime + " "
                ...
                + "a=file-disposition:attachment" + SipUtils.CRLF + "a=sendonly" + SipUtils.CRLF
                + "a=max-size:" + maxSize + SipUtils.CRLF + "a=file-selector:" + fileSelector
                + SipUtils.CRLF;
    }
    ...
    public void testbuildFtSDP() {
        String buildSdp = SdpUtils.buildFileSDP(ipAddress, localMsrpPort, localSocketProtocol,
                acceptedTypes, fileTransferID, fileSelector, "attachment", localSetup,
                localMsrpPath, SdpUtils.DIRECTION_SENDONLY, maxSize);
