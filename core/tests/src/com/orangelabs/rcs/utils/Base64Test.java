...
public class Base64Test extends AndroidTestCase {
    ...
    public final void testBase64() {
        ...
        assertEquals(Base64.encodeBase64ToString(Base64.decodeBase64((new String(
                "MiArIDIgPSBxdWF0cmUsIG5vbiA1Pw==")).getBytes())),
                "MiArIDIgPSBxdWF0cmUsIG5vbiA1Pw==");
        assertEquals(
                new String(Base64.decodeBase64((new String("MiArIDIgPSBxdWF0cmUsIG5vbiA1Pw=="))
                        .getBytes())), ss);
    }
