...
public class GeolocSharingProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase database) {
            database.execSQL(new StringBuilder("CREATE TABLE IF NOT EXISTS ").append(TABLE).append(" (")
                    ...
                    .append(GeolocSharingData.KEY_TIMESTAMP).append(" INTEGER NOT NULL);").toString());
