...
public class JavaPacketizer extends VideoCodec {
	 ...
	 * Packetization mode
	 *
	 * 0 -> Only Single NAL 1 -> Use FU-A if necessary
	 *
	 * Warning: packetization-mode 1 normally requires the management of STAP-A. But, this is not
	 * yet implemented in the stack. Then, there can be some IOT issues if you use this mode.
	 */
