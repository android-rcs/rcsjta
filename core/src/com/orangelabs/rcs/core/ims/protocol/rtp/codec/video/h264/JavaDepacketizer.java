...
public class JavaDepacketizer extends VideoCodec {
	...
	public static class FrameAssembler {
		 ...
		 *
		 * It as package access instead of private for improved performance. See:
		 * http://developer.android.com/guide/practices/performance.html Consider Package Instead of
