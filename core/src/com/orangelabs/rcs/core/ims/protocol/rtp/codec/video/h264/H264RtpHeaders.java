 ...
 * H264RtpHeaders
 *
 * RFC 3984: Two special headers are added to each H264 packet that immediately follows the RTP
 * header:
 *
 * First Header - The FU indicator octet has the following format: +---------------+
 * |0|1|2|3|4|5|6|7| +-+-+-+-+-+-+-+-+ |F|NRI| Type | +---------------+
 *
 * Second Header - The FU header has the following format: +---------------+ |0|1|2|3|4|5|6|7|
 * +-+-+-+-+-+-+-+-+ |S|E|R| Type | +---------------+
 *
