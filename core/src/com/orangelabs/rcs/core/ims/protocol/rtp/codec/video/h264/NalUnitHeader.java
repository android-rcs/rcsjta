 ...
 *
 * NRI: 2 bits nal_ref_idc. A value of 00 indicates that the content of the NAL unit is not used to
 * reconstruct reference pictures for inter picture prediction. Such NAL units can be discarded
 * without risking the integrity of the reference pictures. Values greater than 00 indicate that the
 * decoding of the NAL unit is required to maintain the integrity of the reference pictures.
 *
 * Type: 5 bits nal_unit_type. This component specifies the NAL unit payload type
 *
...
public class NalUnitHeader {
	 ...
	 *            H264 packet
	 * @param header
	 *            Header object to fill with data
