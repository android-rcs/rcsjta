...
public class NativeH264EncoderParams {
	 ...
	 *            Profile level type
	 * @param frameWidth
	 *            Width in pixels of the input frame
	 * @param frameHeight
	 *            Height in pixels of the input frame
	 * @param bitRate
	 *            Bit rate in bit per second
	 * @param frameRate
	 *            Frame rate in the unit of frame per second
	 * @param packetSize
	 *            Packet size in bytes which represents the desired number of bytes per NAL
	 */
