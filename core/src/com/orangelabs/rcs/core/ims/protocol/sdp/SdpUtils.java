...
public class SdpUtils {
	 ...
	 *            Session description part of SDP
	 ...
	 * 
	 * @param mediaDesc
	 *            {@link MediaDescription}
	 * @param sdpAttribute
	 *            SDP attribute string
	 * @param sdpAttributeValue
	 *            SDP attribute value
	 * @param supportAllValuesCharacter
	 *            {@link true} for assume that contains the value if attribute contains '*' as
	 ...
	 * 
	 * @param ipAddress
	 *            local IP address used in o and c line
	 * @param localPort
	 *            local port used in m line
	 * @param protocol
	 *            protocol used in m line
	 * @param acceptTypes
	 *            accepted MIME types
	 * @param wrapperTypes
	 *            accepted wrapper types
	 * @param setup
	 *            connection setup (active, passive, actpass)
	 * @param path
	 * @param direction
	 *            message direction (sendrecv, recvonly)
	 * 
	 * @return SDP
	 */
	 ...
	 *            file-selector
	 * @param disposition
	 *            file-disposition (used only when sendonly)
	 * @param setup
	 *            connection setup (active, passive, actpass)
	 * @param path
	 * @param direction
	 *            message direction (sendonly, recvonly)
	 * @param maxSize
	 *            maximum file size
	 * 
	 * @return SDP
	 ...
	 *            file-selector
	 * @param media
	 *            media description (used for video share)
	 * @param maxSize
	 *            maximum file size
	 * @return SDP
	 */
	 ...
	 * @param path
	 * @param direction
	 *            message direction (sendrecv, recvonly, sendonly)
	 * @param media
	 *            media description (used for video share)
	 * @param maxSize
	 *            maximum file size
