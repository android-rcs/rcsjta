...
public class ConferenceInfoParser extends DefaultHandler {
	 ...
	 * <maximum-user-count>50</maximum-user-count> </conference-description>
	 * 
	 * <!-- CONFERENCE STATE --> <conference-state> <user-count>33</user-count> </conference-state>
	 * 
	 * <!-- USERS --> <users> <!-- USER 1 --> <user entity="sip:bob@example.com" state="full">
	 * <display-text>Bob Hoskins</display-text> <!-- ENDPOINTS --> <endpoint
	 * entity="sip:bob@pc33.example.com"> <display-text>Bob's Laptop</display-text>
	 * <status>disconnected</status> <disconnection-method>departed</disconnection-method>
	 * <disconnection-info> <when>2005-03-04T20:00:00Z</when> <reason>bad voice quality</reason>
	 ...
	 * <src-id>432424</src-id> <status>sendrecv</status> </media> </endpoint> </user>
	 * 
	 * <!-- USER 2 --> <user entity="sip:alice@example.com" state="full">
	 ...
	 * <joining-method>dialed-out</joining-method> <joining-info> <when>2005-03-04T20:00:00Z</when>
	 * <by>sip:mike@example.com</by> </joining-info> <!-- MEDIA --> <media id="1">
	 * <display-text>main audio</display-text> <type>audio</type> <label>34567</label>
	 * <src-id>534232</src-id> <status>sendrecv</status> </media> </endpoint> </user> </users>
	 * </conference-info>
	 */
