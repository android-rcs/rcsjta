...
public interface CoreListener {
	 ...
	 *            Type of request
	 * @param pin
	 *            PIN number requested
	 * @param subject
	 *            Subject
	 * @param text
	 *            Text
	 * @param btnLabelAccept
	 *            Label of Accept button
	 * @param btnLabelReject
