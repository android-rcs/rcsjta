...
public class AuthenticationService extends Service {
	 ...
	 *            The username
	 * @param enableSync
	 *            true to enable synchronization
	 * @param showUngroupedContacts
	 *            true to show ungrouped contacts
	 */
	 ...
	 *            The username for which the account should not be removed (can be null)
	 */
