...
public class ProvisioningParser {
	...
	private void parseSecondaryDevicePar(Node node) {
		 ...
		 * (node == null) { return; } Node childnode = node.getFirstChild();
		 * 
		 * if (childnode != null) { do { if (chat == null) { if ((chat = getValueByParamName("Chat",
		 * childnode, TYPE_INT)) != null) { if (chat.equals("0")) { mRcsSettings.writeParameter(
		 ...
		 * RcsSettingsData.FALSE); } continue; } }
		 * 
		 * if (fileTranfer == null) { if ((fileTranfer = getValueByParamName("FileTranfer",
		 * childnode, TYPE_INT)) != null) { if (fileTranfer.equals("0")) {
		 * mRcsSettings.writeParameter( RcsSettingsData.CAPABILITY_FILE_TRANSFER,
		 * RcsSettingsData.TRUE); } else { mRcsSettings.writeParameter(
		 * RcsSettingsData.CAPABILITY_FILE_TRANSFER, RcsSettingsData.FALSE); } continue; } }
		 * 
		 * if (videoShare == null) { if ((videoShare = getValueByParamName("VideoShare", childnode,
		 * TYPE_INT)) != null) { if (videoShare.equals("0")) { mRcsSettings.writeParameter(
		 ...
		 * RcsSettingsData.FALSE); } continue; } }
		 * 
		 * if (imageShare == null) { if ((imageShare = getValueByParamName("ImageShare", childnode,
		 * TYPE_INT)) != null) { if (imageShare.equals("0")) { mRcsSettings.writeParameter(
		 ...
		 * RcsSettingsData.FALSE); } continue; } }
		 * 
		 * if (geolocPush == null) { if ((geolocPush = getValueByParamName("GeoLocPush", childnode,
		 * TYPE_INT)) != null) { if (geolocPush.equals("0")) { mRcsSettings.writeParameter(
		 ...
		 * RcsSettingsData.FALSE); } continue; } }
		 * 
		 * // Not used for RCS: "SendSms" // Not used for RCS: "VoiceCall"
		 * 
		 * } while ((childnode = childnode.getNextSibling()) != null); }
		 */
	}
