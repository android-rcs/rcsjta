...
/**
 * Content provider for file sharing history
 * 
 * @author Jean-Marc AUFFRET
 */
public class FileSharingLog {
    /**
     * Content provider URI
     */
    public static final Uri CONTENT_URI = Uri.parse("content://com.gsma.services.rcs.provider.fsh/fsh");
    ...
    /**
     * The name of the column containing the unique ID of the file sharing.
     * <P>Type: TEXT</P>
     */
