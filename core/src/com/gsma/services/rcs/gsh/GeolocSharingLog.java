...
public class GeolocSharingLog {
    ...
    /**
     * The name of the column containing the ContactId formatted number of the
     * remote contact.
     * <P>
     * Type: TEXT
     * </P>
    ...
    /**
     * The name of the column containing the geolocation stored as a String that
     * you can pass as an argument to the Geoloc constructor.
     * <P>
     * Type: TEXT
     * </P>
     */
    ...
    /**
     * The name of the column containing the time when geoloc sharing is
     * created.
     * <P>
     * Type: INTEGER
     * </P>
    ...
    /**
     * The name of the column containing the reason code associated with the
