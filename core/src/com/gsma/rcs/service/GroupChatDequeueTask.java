...
/* package private */class GroupChatDequeueTask extends DequeueTask {
    ...
    /* package private */GroupChatDequeueTask(Object lock, String chatId,
            ...
            RcsSettings rcsSettings, HistoryLog historyLog, ContactsManager contactManager) {
