...
public class Artifact {
    ...
    /*
     * Malformed packaging or data: the application package or its metadata is malformed or might
     * have been corrupted. Details: none
     */
    public static final int CODE_MALFORMED = 1000;

    /*
     * Permission denied: the application is not permitted to run based on the configured policy.
     */
    public static final int CODE_BLOCKED_DENIED = 1001;

    /*
     * Revoked application: the application has been revoked and is no longer allowed to be
     * installed. Details: 0: String IARI: the revoked IARI
     */
     ...
     * Details: 0: ICertificateInfo: expired certificate
     */
    public static final int CODE_BLOCKED_EXPIRED = 1003;

    /*
     * Unable to obtain the verification status of the trust certificate, so it might be dangerous
     * to run; processing as untrusted. Details: 0: ICertificateInfo[]: certificates whose status is
     * unknown
     */
    ...
    /*
     * The nature of the problem as an error code STATUS_INVALID: widget package or associated
     * assets not valid STATUS_DENIED: the widget does not have permission for the requested
     * functionality STATUS_CAPABILITY: the runtime does not have the requested functionality others
     * ...
     */
    public int status;
    ...
    /*
     * Details that may be used in constructing a useful error message. Each reason will define the
     * set of expected details.
     */
    public Object[] details;

    /*
     * The specific reason - an internally understood string to pinpoint the assertion or issue
     */
