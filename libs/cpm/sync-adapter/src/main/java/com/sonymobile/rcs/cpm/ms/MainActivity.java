...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public static final String CHAT_AUTHORITY = "com.gsma.services.rcs.provider.chat";
    public static final String FT_AUTHORITY = "com.gsma.services.rcs.provider.ft";
    ...
    public void onClick(View v) {
        ...
        ContentResolver.requestSync(mAccount, CHAT_AUTHORITY, settingsBundle);
        ContentResolver.requestSync(mAccount, FT_AUTHORITY, settingsBundle);
